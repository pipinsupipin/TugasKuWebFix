    ...
    <div class="about-card">
      ...
      <div class="about-content">
        ...
        <p class="about-text">
          ...
          fitur Streak sebagai bentuk dorongan motivasi harian. Fitur ini bertujuan untuk membangun konsistensi dan rasa
    ...
    <div class="mission-values">
      <div class="mission-card">
        ...
        <p class="card-content">
          ...
          aplikasi yang intuitif dan efisien. Dengan fitur manajemen tugas, pengingat ujian, serta sistem streak harian
          yang memotivasi, kami bertujuan membantu pengguna membentuk kebiasaan belajar yang konsisten dan terstruktur,
    ...
    <div class="team-section">
      ...
      <div class="team-grid">
        <div class="team-member">
          ...
          <p class="member-bio">
            Kevin adalah seorang mahasiswa yang memulai startup-nya 3 bulan lalu. Dengan semangat inovasi dan keinginan
        ...
        <div class="team-member">
          ...
          <div class="member-title">CEO & Founder</div>
          <p class="member-bio">
            Abizar adalah seorang mahasiswa yang memulai startup-nya 3 bulan lalu. Dengan semangat inovasi dan keinginan
            kuat untuk menghadirkan solusi nyata, Kevin membangun perusahaannya dari nol. Meskipun masih dalam tahap
            awal, visinya untuk menciptakan teknologi yang inklusif dan berdampak positif menjadi landasan utama dalam
            mengembangkan startup ini.
          </p>
