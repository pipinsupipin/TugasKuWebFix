    ...
    <section class="home" id="home">
        <div class="home-container">
            <div class="home-content">
                ...
                <p>Aplikasi manajemen tugas dan jadwal belajar untuk siswa dan mahasiswa. Dengan fitur Streak,
                    pencatatan tugas dan reminder belajar akan lebih teratur dan menyenangkan!</p>
    ...
    <section class="streak" id="streak">
        ...
        <div class="streak-container">
            <div class="streak-content">
                ...
                <p>
                    Selesaikan tugas kamu setiap hari agar Streak tetap menyala. Semakin lama Streakmu bertahan, semakin
                    besar motivasi untuk tetap produktif. Jangan biarkan apinya padam!
                </p>
            </div>
    ...
    <section class="kategori" id="kategori">
        <div class="kategori-container">
            ...
            <div class="kategori-content">
                ...
                <p>Pilah tugas berdasarkan jenisnya, seperti Tugas, Ujian, atau Meeting agar lebih terorganisir. Temukan
                    dan kelola tugas dengan mudah tanpa perlu mencari satu per satu!</p>
            </div>
    ...
    <section class="kalender" id="kalender">
        ...
        <div class="kalender-container">
            ...
            <div class="kalender-content">
                <p>Cek tugas yang harus diselesaikan lewat Calendar View. Lihat jadwal harian atau mingguanmu dalam
                    sekali lihat agar lebih mudah mengatur waktu belajar.</p>
